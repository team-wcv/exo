...
def main() -> int:
    ...
    p.add_argument("--warmup", action="store_true", help="run one extra warm-up request before timed runs")
    ...
    successful = [r for r in result.requests if r.error is None and r.generation_tokens > 0]
    if successful:
