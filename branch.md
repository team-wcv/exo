...
- Validation run: focused Ruff and BasedPyright pass; model-card pytest passes locally; all seven focused tests pass on the Metal-capable `smbp` twin; launch wrapper passes `zsh -n`.
