...
def test_probeable_interface_rejects_non_lan_paths(monkeypatch):
...
def test_probeable_interface_honors_allowed_cidrs(monkeypatch):
...
def test_probeable_interface_honors_allowed_ips(monkeypatch):
